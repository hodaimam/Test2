...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button googleSignInButton = (Button) findViewById(R.id.buttonGoogleSignIn);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            Constants.EMAIL=mEmailView.getText().toString();
            Constants.pass=mPasswordView.getText().toString();
